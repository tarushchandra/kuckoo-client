...
export type QueryVerifyRefreshTokenArgs = {
...
export type VerifyRefreshTokenQueryQueryVariables = Exact<{
  refreshToken: Scalars['String']['input'];
}>;
...
export type VerifyAccessTokenQueryQueryVariables = Exact<{
  accessToken: Scalars['String']['input'];
}>;


export type VerifyAccessTokenQueryQuery = { __typename?: 'Query', verifyAccessToken: boolean };
...
export const VerifyAccessTokenQueryDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"VerifyAccessTokenQuery"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"accessToken"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"verifyAccessToken"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"accessToken"},"value":{"kind":"Variable","name":{"kind":"Name","value":"accessToken"}}}]}]}}]} as unknown as DocumentNode<VerifyAccessTokenQueryQuery, VerifyAccessTokenQueryQueryVariables>;
